...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #213b52">
      <div class="container">
        ...
        <div class="col-md-6 pe-4 ps-4">
          ...
          method="POST">
            <div class="mb-3"> 
              ...
              <input name="nama" type="name" class="form-control" id="nama" required
            ...
            <div class="form-check">
                ...
                <div class="form-check">
                <input class="form-check-input" type="radio" name="jenis_kelamin" value="Perempuan" id="flexRadioDefault2" required checked>
